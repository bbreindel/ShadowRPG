...
namespace TestEngine.ViewModels
{
    ...
    public class TestInventory
    {
        ...
        public void Test_AddItem()
        {
            ...
            Inventory inventory1 = inventory.AddItemFromFactory(4001);
        ...
        public void Test_AddItems()
        {
            ...
            itemsToAdd.Add(ItemFactory.CreateGameItem(4001));
            itemsToAdd.Add(ItemFactory.CreateGameItem(4002));
            ...
            Inventory inventory2 =
                inventory1
                    .AddItemFromFactory(4001)
                    .AddItemFromFactory(4002);
        ...
        public void Test_RemoveItem()
        {
            ...
            GameItem item1 = ItemFactory.CreateGameItem(4001);
            GameItem item2 = ItemFactory.CreateGameItem(4002);
        ...
        public void Test_RemoveItems()
        {
            ...
            GameItem item1 = ItemFactory.CreateGameItem(4001);
            GameItem item2 = ItemFactory.CreateGameItem(4002);
            GameItem item3 = ItemFactory.CreateGameItem(4002);
        ...
        public void Test_CategorizedItemProperties()
        {
            ...
            Inventory inventory2 = inventory1.AddItemFromFactory(4001);
            ...
            Inventory inventory4 = inventory3.AddItemFromFactory(3001);
        ...
        public void Test_RemoveItemQuantities()
        {
            ...
            Assert.AreEqual(2, inventory2.Items.Count(i => i.ItemTypeID == 4001));
            ...
            Assert.AreEqual(2, inventory3.Items.Count(i => i.ItemTypeID == 4001));
            ...
            Assert.AreEqual(2, inventory4.Items.Count(i => i.ItemTypeID == 4001));
        }
